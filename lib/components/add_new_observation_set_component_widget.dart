                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) async {
                                    safeSetState(() {});
                                    if (_model.temperatureTextController.text !=
                                            '') {
                                      _model.tempFahrenheit =
                                          _model.tempUnitsValue == '°F'
                                              ? double.tryParse(_model
                                                  .temperatureTextController
                                                  .text)
                                              : functions.celsiusToFahrenheit(
                          ...
                          Expanded(
                            child: FlutterFlowChoiceChips(
                              options: [
                                ...
                                ChipData(
                                    'Supplemental Oxygen', Icons.masks_rounded)
                              ],
                              onChanged: (val) async {
                                safeSetState(() =>
                                    _model.airOrOxygenValue = val?.firstOrNull);
                              ...
                              alignment: WrapAlignment.start,
                              controller: _model.airOrOxygenValueController ??=
                                  FormFieldController<List<String>>(
                                ['Room Air'],
                              ),
                              wrapped: false,
                            ...
                            bundleJsonJson:
                                functions.generateNEWS2ObservationPostJSON(
                                    ...
                                    functions.datetimeToISO8601String(
                                        getCurrentTimestamp)!,
                                    int.parse(_model.pulseTextController.text),
                                    int.parse(
                                        _model.systolicBPTextController.text),
                                    int.parse(
                                        _model.diastolicBPTextController.text),
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Error'),
                                  content: Text(
                                      (_model.postNEWSObservations?.bodyText ??
                                          '')),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
